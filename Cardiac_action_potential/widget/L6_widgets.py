...
class VentricularAPWidget():
    ...
    def __init__(self):
        ...
        interact(self.solve_and_plot,
                          ...
                          GNa_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gNa scale factor', continuous_update=False, style=style, layout=layout),
                          GtoSlow_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gto,slow scale factor', continuous_update=False, style=style, layout=layout),
                          GtoFast_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gto,fast scale factor', continuous_update=False, style=style, layout=layout),
                          Gkr_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gKr scale factor', continuous_update=False, style=style, layout=layout),
                          Gks_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gKs scale factor', continuous_update=False, style=style, layout=layout),
                          Gkp_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gKp scale factor', continuous_update=False, style=style, layout=layout),
                          Gk1_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gK1 scale factor', continuous_update=False, style=style, layout=layout),
                          GClCa_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gClCa scale factor', continuous_update=False, style=style, layout=layout),
                          pCa_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gCa scale factor', continuous_update=False, style=style, layout=layout),
                          VNCX_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='NCX Vmax scale factor', continuous_update=False, style=style, layout=layout),
                          VNaK_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='NKa Vmax scale factor', continuous_update=False, style=style, layout=layout),
                          GNaB_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gNaB scale factor', continuous_update=False, style=style, layout=layout),
                          GCaB_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gCaB scale factor', continuous_update=False, style=style, layout=layout),
                          GClB_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gClB scale factor', continuous_update=False, style=style, layout=layout))
...
class AtrialAPWidget():
    ...
    def __init__(self):
        ...
        interact(self.solve_and_plot,        
                          ...
                          GtoFast_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gto,fast scale factor', continuous_update=False, style=style, layout=layout),
                          Gkr_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gKr scale factor', continuous_update=False, style=style, layout=layout),
                          Gkur_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gKur scale factor', continuous_update=False, style=style, layout=layout),
                          Gks_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gKs scale factor', continuous_update=False, style=style, layout=layout),
                          Gkp_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gKp scale factor', continuous_update=False, style=style, layout=layout),
                          Gk1_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gK1 scale factor', continuous_update=False, style=style, layout=layout),
                          GClCa_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gClCa scale factor', continuous_update=False, style=style, layout=layout),
                          ...
                          GCaB_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gCaB scale factor', continuous_update=False, style=style, layout=layout),
                          GClB_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gClB scale factor', continuous_update=False, style=style, layout=layout),
                          GkAch_coeff = FloatSlider(value=1, min=0, max=10, step=0.1, description='gKAch scale factor', continuous_update=False, style=style, layout=layout),
                          Ach = FloatSlider(value=0, min=0, max=0.1, step=0.001, description='Ach scale factor', continuous_update=False, style=style, layout=layout))
